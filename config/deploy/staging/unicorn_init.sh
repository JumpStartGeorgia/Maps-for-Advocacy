...
##### SET THESE VARIABLES ########
##################################
AS_USER=accessibility-staging # name of user on server
APP_ROOT=/home/accessibility-staging/Accessibility-Staging/current # path to application current folder
