...
QuestionPairing.create(:id => 5, :question_category_id => qc.id, :question_id => q.id, :sort_order => 2)
...
QuestionPairing.create(:id => 6, :question_category_id => qc.id, :question_id => q.id, :sort_order => 3)
...
qp = QuestionPairing.create(:id => 7, :question_category_id => qc.id, :question_id => q.id, :sort_order => 4)
...
QuestionPairing.create(:id => 8, :question_category_id => qc.id, :question_id => q.id, :sort_order => 5)
...
qp = QuestionPairing.create(:id => 13, :question_category_id => qc.id, :question_id => 7)
qp.question_pairing_translations.create(:locale => 'en', :evidence => 'Width (m)')
qp.question_pairing_translations.create(:locale => 'ka', :evidence => 'Width (m)')
QuestionPairing.create(:id => 14, :question_category_id => qc.id, :question_id => 6, :sort_order => 3)
QuestionPairing.create(:id => 15, :question_category_id => qc.id, :question_id => 2, :sort_order => 4)
...
QuestionPairing.create(:id => 16, :question_category_id => qc.id, :question_id => q.id, :sort_order => 5)
...
QuestionPairing.create(:id => 17, :question_category_id => qc.id, :question_id => q.id, :sort_order => 6)
...
QuestionPairing.create(:id => 18, :question_category_id => qc.id, :question_id => q.id, :sort_order => 7)
