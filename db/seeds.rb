...
d.disability_translations.create(:locale => 'ka', :name => 'სმენის ნაწილობრივი შეზღუდვის მქონე პირები')
...
d.disability_translations.create(:locale => 'ka', :name => 'გადაადგილების შეზღუდვის მქონე პირები')
...
d.disability_translations.create(:locale => 'ka', :name => 'ფსიქოსოციალური პრობლემების მქონე პირები')
...
r.right_translations.create(:locale => 'ka', :name => "ჰაბილიტაციისა და რეაბილიტაციის უფლება", :convention_article => "26")
r = Right.create(:id => 6)
...
r.right_translations.create(:locale => 'ka', :name => "ჯანმრთელობის უფლება", :convention_article => "25")
r = Right.create(:id => 8)
