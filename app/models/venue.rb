class Venue < ActiveRecord::Base
  ...
  attr_accessible :id, :venue_category_id, :custom_question_category_id, :custom_public_question_category_id, :venue_translations_attributes, :sort_order, :unique_id
